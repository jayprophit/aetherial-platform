        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center space-x-3 px-4 py-3 border-2 border-gray-200 rounded-lg hover:border-gray-300 hover:bg-gray-50 transition"
            >
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-sm text-gray-600 text-center mb-4">Or sign in with</p>
            <div className="grid grid-cols-4 gap-3">
              <button
                onClick={() => handleSocialLogin('twitter')}
                className="p-3 border-2 border-gray-200 rounded-lg hover:border-gray-300 hover:bg-gray-50 transition"
                title="Twitter"
              >
                <svg className="w-5 h-5 mx-auto" fill="#1DA1F2" viewBox="0 0 24 24">
              ...
              <button
                ...
                title="LinkedIn"
              >
                <svg className="w-5 h-5 mx-auto" fill="#0A66C2" viewBox="0 0 24 24">
              ...
              <button
                ...
                title="GitHub"
              >
                <svg className="w-5 h-5 mx-auto" fill="#181717" viewBox="0 0 24 24">
